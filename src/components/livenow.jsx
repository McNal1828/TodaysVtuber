		...
		<div className='recommends'>
			<div className='recommend'>
				<div className='header'>
					<span className='text'>생방송중</span>
				</div>
				<div className='ytb-icon-list'>
					<div className='ytb-icon'>
						<div className='icon' style={{ position: 'relative', left: '23.3%', top: '63%', color: 'red' }}>
							<i
					...
					<div className='ytb-icon'>
						<img src='https://yt3.ggpht.com/ytc/AMLnZu-qIRWBQWhOxBeYS5gd5H-sqys1F6EPAmqCW1Q6HQ=s800-c-k-c0x00ffffff-no-rj' alt='경로이상' />
					</div>
					<div className='ytb-icon'>
						<img
